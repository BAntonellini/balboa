...
def mayra_daily_loan_run():
    ...
    def extract_and_load_dlt():
        load_us_population = DatacovesBashOperator(
            ...
            bash_command="echo 'The value of my Airflow variable is: {{ var.value.my_var }}' && python load/dlt/csv_to_snowflake/load_csv_data.py",
        )
